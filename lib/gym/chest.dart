    ...
    return Scaffold(
      ...
      body: Container(
        child: ListView(
          ...
          children: <Widget>[
            ModuleWidget(SubModuleWidgetGym('c1'), 'Barbell Bench Press',
                'assets/images/gym/chest/barbell.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(SubModuleWidgetGym('c2'), 'Flat Bench Dumbbell Press',
                'assets/images/gym/chest/flat_dumbell.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(
                SubModuleWidgetGym('c3'),
                'Low-Incline Barbell Bench Press',
                'assets/images/gym/chest/low_incline.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(SubModuleWidgetGym('c4'), 'Seated Machine Chest Press',
                'assets/images/gym/chest/machine_press.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(SubModuleWidgetGym('c5'), 'Incline Dumbbell Press',
                'assets/images/gym/chest/incline_dumbell_press.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(SubModuleWidgetGym('c6'), 'Dips For Chest',
                'assets/images/gym/chest/chest_dips.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(SubModuleWidgetGym('c7'), 'Incline Bench Cable Fly',
                'assets/images/gym/chest/cable_fly.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(SubModuleWidgetGym('c8'), 'Pec-Deck Machine',
