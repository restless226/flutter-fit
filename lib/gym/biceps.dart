    ...
    return Scaffold(
      ...
      body: Container(
        child: ListView(
          ...
          children: <Widget>[
            ModuleWidget(
                SubModuleWidgetGym('bi1'),
                'Incline Dumbbell Hammer Curl',
                'assets/images/gym/bicep/hammer_curl.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(SubModuleWidgetGym('bi2'), 'Incline Inner-Biceps Curl',
                'assets/images/gym/bicep/incline_hammer_curl.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(SubModuleWidgetGym('bi3'), 'EZ-Bar Curl',
                'assets/images/gym/bicep/ez_bar_curl.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(
                SubModuleWidgetGym('bi4'),
                'Wide-Grip Standing Barbell Curl',
                'assets/images/gym/bicep/wide_curl.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(SubModuleWidgetGym('bi5'), 'Zottman Curl',
                'assets/images/gym/bicep/zottman_curl.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(SubModuleWidgetGym('bi6'), 'Barbell Curl',
                'assets/images/gym/bicep/barbell_curl.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(SubModuleWidgetGym('bi7'), 'Hammer Curl',
                'assets/images/gym/bicep/hammer_curl.jpg'),
            SizedBox(
              height: 8,
            ),
            ModuleWidget(SubModuleWidgetGym('bi8'), 'Overhead Cable Curl',
